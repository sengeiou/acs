...
//        setLayerType(LAYER_TYPE_HARDWARE, mPaint);//禁止view硬件加速？
        ...
        try {
            ...
            setPadding(
                    (int) typedArray.getDimension(
                            R.styleable.ShadowLayout_sl_shadow_padding, 0
                    )
            );
            setShadowRadius(
...
//        resetShadow();
    ...
    public void resetShadow() {
        ...
        int padding = mPadding == 0 ? (int) (mShadowDistance + mShadowRadius) : mPadding;
            ...
            if (mInvalidateShadow) {
                ...
                if (getWidth() != 0 && getHeight() != 0) {
                    if (mBitmap == null || mBitmap.isRecycled()) {
                        ...
                        mCanvas.drawBitmap(extractedAlpha, 0, 0, mPaint);
