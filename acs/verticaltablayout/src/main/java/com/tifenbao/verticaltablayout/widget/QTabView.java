...
public class QTabView extends TabView {
    ...
    private TabBackground mTabbackground;
    ...
    @Override
    public QTabView setTabBackground(TabBackground background) {

        if(background!=null){
            mTabbackground=background;
            super.setBackgroundColor(isChecked() ?background.getBackgroundSelected():background.getBackgroundNormal());
        }else{
            setDefaultBackground();
        }
        return this;
    ...
    public void setChecked(boolean checked) {
        ...
        if(mTabbackground!=null){
            super.setBackgroundColor(isChecked() ?mTabbackground.getBackgroundSelected():mTabbackground.getBackgroundNormal());
        }
        initIconView();
    }
