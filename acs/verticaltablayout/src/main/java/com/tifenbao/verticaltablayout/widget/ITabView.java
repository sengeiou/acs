package com.tifenbao.verticaltablayout.widget;
...
public interface ITabView {
    ...
    ITabView setTabBackground(TabBackground background);
    ...
    class TabBackground {
        ...
        private TabBackground(Builder mBuilder) {
            this.mBuilder = mBuilder;
        }

        public int getBackgroundSelected() {
            return mBuilder.mBackgroundSelected;
        }

        public int getBackgroundNormal() {
            return mBuilder.mBackgroundNormal;
        }
        ...
        public static class Builder {
            ...
            public Builder() {
                this.mBackgroundSelected = 0xFFFF4081;
                this.mBackgroundNormal = 0xFF757575;
            }

            public Builder setBackgroundColor(int colorSelected, int colorNormal) {
            ...
            public TabBackground build() {
                return new TabBackground(this);
            }
        }
    }
}
