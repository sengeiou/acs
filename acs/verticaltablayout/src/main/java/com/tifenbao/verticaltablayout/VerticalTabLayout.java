package com.tifenbao.verticaltablayout;
...
import com.tifenbao.verticaltablayout.adapter.TabAdapter;
import com.tifenbao.verticaltablayout.util.DisplayUtil;
import com.tifenbao.verticaltablayout.util.TabFragmentManager;
import com.tifenbao.verticaltablayout.widget.QTabView;
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < adapter.getCount(); i++) {
                addTab(new QTabView(mContext).setIcon(adapter.getIcon(i))
                        ...
                        .setTabBackground(adapter.getTabBackground(i)));
            }
        }
    }
